                  ...
                  child: Center(
                      child: Text(
                        ...
                        style: TextFontStyle.headlogincFFFFFF10montserratw700
                            .copyWith(color: const Color(0xffcffffff), fontSize: 15.sp),
                      )),
                ),
                  ...
                  child: Center(
                      child: Text(
                        ...
                        style: TextFontStyle.headlinec34297910w400
                            .copyWith(color: const Color(0xffc342979), fontSize: 15.sp),
                      )),
                ),
              ],
            ),
                  ...
                  child: Container(
                    ...
                    child: Center(
                        child: Text(
                          ...
                          style: TextFontStyle.headlogincFFFFFF10montserratw700
                              .copyWith(
                              color: const Color(0xffcFFFFFF), fontSize: 15.sp),
                        )),
                  ),
                ),
              ],
