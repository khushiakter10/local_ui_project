                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        ...
                        style: TextFontStyle.headlinepassc7978B4
                            .copyWith(color: Color(0xffc7978B4), fontSize: 10),
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextFontStyle.headlinepassc7978B4.copyWith(
                            color: Color(0xffc7978B4), fontSize: 10.sp),
                      ),
                    ],
                  ),
                ],
              ...
              children: [
                ...
                Text("I have read and accept the terms of use.",
                    style: TextFontStyle.headlineaccept8c5C5490
                        .copyWith(color: Color(0xffc5C5490), fontSize: 11.sp)),
              ],
            ),
            Row(
              children: [
                ...
                Text("I have read and accept the terms of use.",
                    style: TextFontStyle.headlineaccept8c5C5490
                        .copyWith(color: Color(0xffc5C5490), fontSize: 11)),
              ],
            ),
            UIHelper.verticalSpace(20.h),
            Container(
