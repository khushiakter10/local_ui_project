                              ...
                              children: [
                                ...
                                AnimatedOpacity(
                                  ...
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      Text("06",style: TextFontStyle.w600cB7B9D7montserrat.copyWith(color: Color(0xffcB7B9D7),fontSize: 15)),
                                      Text("09",style: TextFontStyle.w600cB7B9D7montserrat.copyWith(color: Color(0xffcB7B9D7),fontSize: 15)),
                                      Text("12",style: TextFontStyle.w600cB7B9D7montserrat.copyWith(color: Color(0xffcB7B9D7),fontSize: 15)),
                                      Text("15",style: TextFontStyle.w600cB7B9D7montserrat.copyWith(color: Color(0xffcB7B9D7),fontSize: 15)),
                                      Text("18",style: TextFontStyle.w600cB7B9D7montserrat.copyWith(color: Color(0xffcB7B9D7),fontSize: 15)),
                                      Text("21",style: TextFontStyle.w600cB7B9D7montserrat.copyWith(color: Color(0xffcB7B9D7),fontSize: 15)),
                                      Text("00",style: TextFontStyle.w600cB7B9D7montserrat.copyWith(color: Color(0xffcB7B9D7),fontSize: 15)),
                                    ],
                                  ),
                                ),
                              ],
